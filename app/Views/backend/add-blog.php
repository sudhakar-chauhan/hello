				...
				<div class="panel panel-default card-view">
					<div class="panel-wrapper collapse in">
						<div class="panel-body">
							...
							?>
							<div class="form-wrap">
								<form action="<?= base_url('admin/add-blog') ?>" method="POST" enctype="multipart/form-data">
									<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>Add Blog</h6>
									...
									<div class="row">
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												...
												<input type="text" id="heading" name="heading" value="<?= old('heading') ?>" class="form-control <?= validation_show_error('heading') ? "error" : "" ?>" placeholder="Heading" required>
												...
												<select class="form-select <?= validation_show_error('category') ? "error" : "" ?>" name="category" data-placeholder="Choose a Category" tabindex="1">
													...
													<?php if ($category) :
														foreach ($category as $row) : ?>
															<option value="<?= $row->blog_category_id ?>" <?= old('category') == $row->blog_category_id ? "selected" : "" ?>>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<textarea class="form-control blogDescription <?= validation_show_error('blogDescription') ? "error" : "" ?>" name="blogDescription" placeholder="Blog Description" rows="4"><?= old('blogDescription') ?></textarea>
											</div>
										</div>
									</div>
